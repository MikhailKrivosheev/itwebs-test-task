...
function Hero() {
  return (
    <Section title="Hello, dear candidate" tag="h1" className="[&>p]:mb-2">
      <p>
      ...
      <p>
        ...
        transitioning to a new level of operations. Our company policy is to give all employees more
        freedom in decision-making. In other words, we&apos;re not looking for just a developer who
        uses the knowledge they&apos;ve learned during their internship, but someone who can offer
        their own options and ideas, should they arise.
      </p>
      ...
      <ul className="mt-4 flex flex-col gap-4">
        <li className={LI_STYLES}>
          ...
          <div className="ml-3 flex flex-col gap-2">
            ...
            <span>3. Create a modal window with at least 2 input fields (1 - text, 2 - file)</span>
            <span>
              4. Display the sending of a POST request with the data collected from the modal window
              (optionally, you can also display WebSockets)
            </span>
          </div>
        </li>
        <li className={LI_STYLES}>
